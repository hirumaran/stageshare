...
export const DAILY_DITHER_PRESETS: PairedDitherPreset[] = [
  {
    ...
    light: makePalette(
      "Indigo Backstage",
      {
        background: "#F3EFE8",
        darkLayer: "#E4DDD2",
        ditherPrimary: "#5A5580",
        ditherSecondary: "#7A75A0",
        ditherOpacity: 0.26,
      },
      0.25,
    ),
  },
  {
    ...
    light: makePalette(
      "Amber Spotlight",
      {
        background: "#F6EEDC",
        darkLayer: "#E9D8B8",
        ditherPrimary: "#7A6E52",
        ditherSecondary: "#A8936A",
        ditherOpacity: 0.22,
      },
      0.25,
    ),
  },
  {
    ...
    light: makePalette(
      "Olive Velvet",
      {
        background: "#EFF3E8",
        darkLayer: "#DDE7D1",
        ditherPrimary: "#5A6B48",
        ditherSecondary: "#7A8A62",
        ditherOpacity: 0.22,
      },
      0.25,
    ),
  },
  {
    ...
    light: makePalette(
      "Wine Curtain",
      {
        background: "#F4EAEA",
        darkLayer: "#E8D5D3",
        ditherPrimary: "#8A5A58",
        ditherSecondary: "#A87874",
        ditherOpacity: 0.20,
      },
      0.25,
    ),
  },
  {
    ...
    light: makePalette(
      "Dusty Plum",
      {
        background: "#F0ECF3",
        darkLayer: "#DED6E7",
        ditherPrimary: "#5E5080",
        ditherSecondary: "#7E72A0",
        ditherOpacity: 0.24,
      },
      0.25,
    ),
  },
  {
    ...
    light: makePalette(
      "Aged Brass",
      {
        background: "#F5EEDC",
        darkLayer: "#E5D6B6",
        ditherPrimary: "#7A6A40",
        ditherSecondary: "#9A884E",
        ditherOpacity: 0.22,
      },
      0.25,
    ),
  },
  {
    ...
    light: makePalette(
      "Blue Shadow",
      {
        background: "#EEF1F4",
        darkLayer: "#D9DEE7",
        ditherPrimary: "#4A5A78",
        ditherSecondary: "#6A7A9A",
        ditherOpacity: 0.24,
      },
      0.25,
    ),
